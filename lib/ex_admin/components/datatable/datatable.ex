defmodule ExAdmin.Components.Datatable do
  @moduledoc """
  An ExAdmin component for server side datatables.
  """
  ...
  * :key ("order") -- set the params key
  ...
  ## Examples
      ...
      iex> ExAdmin.Components.Datatable.sort_column_class(%{params: %{"order" => "email_asc"}}, :email)
      " sorted-desc"

      iex> ExAdmin.Components.Datatable.sort_column_class(%{params: %{"order" => "email_asc"}}, :address)
      ""
  ...
  * :prefix (" sorted-")
  ...
  ## Examples
      ...
      iex> ExAdmin.Components.Datatable.sort_column_order("field_name_asc")
      {:asc, :field_name}

      iex> ExAdmin.Components.Datatable.sort_column_order("name_desc")
      {:desc, :name}
